...
/**
 *      API URL: http://content.guardianapis.com/search?from-date=2018-01-31&q=lifestyle&api-key=b7933e6a-83fc-4375-9c0e-b6257f27b298
 *      Change from-date parameter to use the current date
 *
 */
...
*/
    ...
    private String makeURL(){
        ...
        url.append("&q=lifestyle&api-key=b7933e6a-83fc-4375-9c0e-b6257f27b298");
    ...
    private void fetchFakeData() {
        News news = new News("7 killed in a car accident");
        newsList.add(news);
        ...
        news = new News("10 killed in a car accident");
        newsList.add(news);
